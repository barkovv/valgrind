...
static irop_t irops[] = {
  ...
  { DEFOP(Iop_Cnt8x16, UNDEF_UNKNOWN), .s390x = 1},
  { DEFOP(Iop_Cnt16x8, UNDEF_UNKNOWN), .s390x = 1},
  { DEFOP(Iop_Cnt32x4, UNDEF_UNKNOWN), .s390x = 1},
  { DEFOP(Iop_Cnt64x2, UNDEF_ALL_64x2), .s390x = 1},
